...
<div class="panel-display brenham clearfix <?php !empty($class) ? print $class : ''; ?>" <?php !empty($css_id) ? print "id=\"$css_id\"" : ''; ?>>
  ...
  <div class="brenham-container brenham-page-top clearfix panel-panel">
    <div class="brenham-container-inner brenham-page-top-inner panel-panel-inner">
  ...
  <div class="brenham-container brenham-navbar clearfix panel-panel">
    <div class="brenham-container-inner brenham-navbar-inner panel-panel-inner">
      <?php print $content['navbar']; ?>
    </div>
  </div>
  
  <div class="brenham-container brenham-highlight clearfix panel-panel">
    <div class="brenham-container-inner brenham-highlight-inner panel-panel-inner">
  ...
  <div class="brenham-container brenham-footer clearfix panel-panel">
    <div class="brenham-column-content-region-inner brenham-footer-inner panel-panel-inner">
