...
<!-- ______________________ HEADER _______________________ -->
  ...
  <?php if ($breadcrumb): ?>
    <div id="breadcrumb-slogan" class="clearfix">
        ...
        <div class="service-links floatright"><?php print "<ul><li>" . implode("</li><li>", service_links_render($node, FALSE)) . "</li></ul>"; ?></div>
    </div>
  <?php endif; ?>
      ...
      <div id="content-inner" class="inner column center">
        ...
        <?php if ($title|| $messages || $tabs || $action_links): ?>
          <div id="content-header">
            <?php if ($title): ?>
              <h1 class="title element-invisible"><?php print $title; ?></h1>
            <?php endif; ?>
            <?php print $messages; ?>
